...
void Plot50kCDet(Int_t RunNumber1=4302, Int_t RunSegment=3, Int_t nevents=50000, Int_t neventsr=50000,
  ...
  if(!T) { 
    ...
    //subfile = TString::Format("gep5_replayed_nogems_%d_50k_events",RunNumber1);
    subfile = TString::Format("gep5_replayed_%d_50k_events_firstseg_%d",RunNumber1, RunSegment);
  ...
  TString subfile; 
  subfile = TString::Format("gep5_replayed_%d_50k_events_firstseg_%d.root",RunNumber1,RunSegment);
