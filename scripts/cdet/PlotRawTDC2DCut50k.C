...
void PlotRawTDC2DCut50k(Int_t RunNumber1=3311, Int_t nevents=50000,
...
TCanvas *plotBarRates(){
  ...
  Double_t rate_level = 120; // Expect 600 for 50000 events
