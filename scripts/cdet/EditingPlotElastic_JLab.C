...
const TString ANALYSED_DIR = "/work/hallc/gep/brash/CDet_replay/sbs/Rootfiles/cdetFiles";
...
void EditingPlotElastic_JLab(Int_t RunNumber1=5811, Int_t nevents=50000, Int_t neventsr=500000, Int_t elastic = 0, Int_t onlySegment = -1,
