...
void PlotElastic_with_barhist_offsets_io_ecalcorr_apply_timewalk_fit(Int_t RunNumber1=5811, Int_t nevents=50000, Int_t elastic = 0, Int_t minSeg = -1, Int_t maxSeg = -1,
