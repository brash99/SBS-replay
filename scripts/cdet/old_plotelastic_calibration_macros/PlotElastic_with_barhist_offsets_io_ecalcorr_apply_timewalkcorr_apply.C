...
double gTimeWalkP1_L1 = 16.961;      // ns*sqrt(ns)
double gTimeWalkP1_L2 = 19.197;      // ns*sqrt(ns)
...
void PlotElastic_with_barhist_offsets_io_ecalcorr_apply_timewalkcorr_apply(Int_t RunNumber1=5811, Int_t nevents=50000, Int_t elastic = 0, Int_t minSeg = -1, Int_t maxSeg = -1,
